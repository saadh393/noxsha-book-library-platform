...
import { BookOpen, Grid3x3, Type, MessageSquare, Share2, Mail } from 'lucide-react';
...
export default function AdminSidebar({ currentPage, onPageChange, isOpen }: AdminSidebarProps) {
  return (
    <motion.aside
    ...
    >
      ...
      <div className="px-4 py-6 border-t border-[#3D2B5E]">
        <p className="text-xs text-gray-400 text-center">অ্যাডমিন ড্যাশবোর্ড সংস্করণ ১.০</p>
      </div>
    </motion.aside>
  );
}
